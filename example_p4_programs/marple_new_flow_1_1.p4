...
blackbox stateful_alu A19e1eaaf174b8f4_stateful_alu_0_0_blackbox {
    ...
    update_hi_2_value         : (ipv4.pkt_0) + (0);
    output_predicate          : 1;
    output_value              : alu_hi;
...
// Stateful ALU Action
action A19e1eaaf174b8f4_stateful_alu_0_0_action () {
    A19e1eaaf174b8f4_stateful_alu_0_0_blackbox.execute_stateful_alu(0);
...
// Stateful ALU table
@pragma ignore_table_dependency A19e1eaaf174b8f4_stateful_alu_0_0_table

@pragma stage 0
table A19e1eaaf174b8f4_stateful_alu_0_0_table {
    actions {
        A19e1eaaf174b8f4_stateful_alu_0_0_action;
    }
    default_action: A19e1eaaf174b8f4_stateful_alu_0_0_action;
}
...
control ingress {
    // Call all the required ALUs.
          ...
          apply(A19e1eaaf174b8f4_stateful_alu_0_0_table);

...
blackbox stateful_alu test_stateful_alu_2_0_blackbox {
    ...
    reg                       : reg_0;
    condition_lo              : ((ipv4.pkt_arrival0-register_lo)+10)==0;
    condition_hi              : (0+13)<0;
    update_lo_1_predicate     : true;
    update_lo_1_value         : (ipv4.pkt_arrival0)-(1);
    update_lo_2_predicate     : true;

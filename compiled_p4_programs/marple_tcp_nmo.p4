...
blackbox stateful_alu test_stateful_alu_1_1_blackbox {
    ...
    reg                       : reg_1;
    condition_lo              : ((0-ipv4.p_br_tmp0)-0)<0;
    condition_hi              : ((0-ipv4.p_br_tmp0)-register_lo)>0;
    update_lo_1_predicate     : (condition_hi) and (condition_lo);
    update_lo_1_value         : (3)-(register_lo);
    update_lo_2_predicate     : true;
    update_lo_2_value         : (ipv4.p_br_tmp0)+(register_lo);

...
class Synthesizer:
    ...
    def perform_merge(self, a, b):
        ...
        # if special merge, remove pred_to_remove if its out-degree is zero, as b has the same state update
        if special_merge and self.comp_graph.out_degree(pred_to_remove) == 0:

...
blackbox stateful_alu test_stateful_alu_1_1_blackbox {
    ...
    reg                       : reg_1;
    condition_lo              : (ipv4.p_ttl0-alu_lo)>0;
    condition_hi              : ((0-ipv4.p_ttl0)+alu_lo)>0;
    update_lo_1_predicate     : true;
    update_lo_1_value         : (ipv4.p_ttl0);
    update_lo_2_predicate     : false;
    update_lo_2_value         : (0);
    update_hi_1_predicate     : false;
    update_hi_1_value         : (3)-(alu_lo);
    update_hi_2_predicate     : (condition_hi) or (condition_lo);
    update_hi_2_value         : (1)-(ipv4.p_br_tmp0);
    output_predicate          : 1;
    output_value              : alu_hi;
    output_dst                : ipv4.p_br_tmp2;
...
blackbox stateful_alu test_stateful_alu_2_2_blackbox {
    ...
    reg                       : reg_2;
    condition_lo              : (((0-ipv4.p_br_tmp0)-alu_lo)+3)==0;
    condition_hi              : (ipv4.p_br_tmp0-0)==0;
    update_lo_1_predicate     :  not (condition_hi);
    update_lo_1_value         : (ipv4.p_br_tmp2);
    update_lo_2_predicate     : (condition_hi);
    update_lo_2_value         : (ipv4.p_br_tmp2)+(alu_lo);
    update_hi_1_predicate     :  not (condition_hi);
    update_hi_1_value         : (9)-(alu_hi);
    update_hi_2_predicate     : (condition_hi) and (condition_lo);
    update_hi_2_value         : (7)+(9);
    output_predicate          : 1;
    output_value              : alu_lo;
    output_dst                : ipv4.ttl_change;
...
action test_stateless_alu_0_0_action () {
    ...
    modify_field(ipv4.p_id1, ipv4.p_rdata0);

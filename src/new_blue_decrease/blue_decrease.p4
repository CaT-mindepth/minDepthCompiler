...
blackbox stateful_alu test_stateful_alu_0_0_blackbox {
    ...
    reg                       : reg_0;
    condition_lo              : =(((0-p_now_plus_free1)+last_update_0)+1)>0;
    condition_hi              : =(((0-p_now_plus_free1)+last_update_0)+2)!=0;
    update_lo_1_predicate     : true;
    update_lo_1_value         : (p_now0);
    update_lo_2_predicate     : true;
    update_lo_2_value         : (3) - (register_hi_1);
    update_hi_1_predicate     : true;
    update_hi_1_value         : (register_hi_1);
    update_hi_2_predicate     : true;
    update_hi_2_value         : (register_hi_1) - (2);
    output_predicate          : 1;
    output_value              : register_hi;
    output_dst                : p_p_mark2;

...
blackbox stateful_alu test_stateful_alu_0_0_blackbox {
    ...
    reg                       : reg_0;
    condition_lo              : ((ipv4.p_util0-alu_lo)+1)>0;
    condition_hi              : ((0-ipv4.p_path_id0)+alu_hi)==0;
    update_lo_1_predicate     : false;
    update_lo_1_value         : (1)-(0);
    update_lo_2_predicate     : (condition_hi) or ( not (condition_lo));
    update_lo_2_value         : (ipv4.p_util0)+(0);
    update_hi_1_predicate     :  not (condition_lo);
    update_hi_1_value         : (ipv4.p_path_id0);
    update_hi_2_predicate     : false;
    update_hi_2_value         : (ipv4.p_path_id0);
    output_predicate          : 1;
    output_value              : alu_hi;
    output_dst                : ipv4.best_path;

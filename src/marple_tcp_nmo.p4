...
blackbox stateful_alu test_stateful_alu_0_0_blackbox {
    ...
    reg                       : reg_0;
    condition_lo              : ((0-ipv4.p_tcpseq0)+alu_lo)>0;
    condition_hi              : (((0-ipv4.p_tcpseq0)+alu_hi)+31)<0;
...
blackbox stateful_alu test_stateful_alu_1_1_blackbox {
    ...
    condition_hi              : (((0-ipv4.p_br_tmp0)-0)+1) not =0;
    ...
    update_hi_1_value         : (ipv4.p_br_tmp0)-(22);

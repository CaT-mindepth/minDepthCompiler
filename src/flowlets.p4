...
blackbox stateful_alu test_stateful_alu_1_1_blackbox {
    ...
    reg                       : reg_1;
    condition_lo              : (((0-ipv4.pkt_br_tmp0)-alu_hi)+1)==0;
    condition_hi              : (((0-ipv4.pkt_new_hop0)+alu_lo)+1)==0;
    update_lo_1_predicate     : (condition_lo);
    update_lo_1_value         : (ipv4.pkt_new_hop0);
    update_lo_2_predicate     : false;
    update_lo_2_value         : (ipv4.pkt_new_hop0);
    update_hi_1_predicate     : false;
    update_hi_1_value         : (7)-(12);
    update_hi_2_predicate     :  not (condition_lo);
    update_hi_2_value         : (21)-(19);
    output_predicate          : 1;
    output_value              : alu_lo;
    output_dst                : ipv4.pkt_next_hop1;

...
blackbox stateful_alu test_stateful_alu_1_0_blackbox {
    ...
    reg                       : reg_0;
    condition_lo              : (ipv4.p_pkt_10-alu_lo)>0;
...
blackbox stateful_alu test_stateful_alu_2_1_blackbox {
    ...
    reg                       : reg_1;
    condition_lo              : ((ipv4.p__br_tmp00+alu_lo)+1)==0;
    condition_hi              : ((0-ipv4.p__br_tmp00)+1)==0;
    update_lo_1_predicate     : (condition_hi);
    update_lo_1_value         : (ipv4.p__br_tmp00)+(alu_lo);
    update_lo_2_predicate     : (condition_hi) and (condition_lo);
    update_lo_2_value         : (16)+(19);
    update_hi_1_predicate     : ( not (condition_hi)) and (condition_lo);
    update_hi_1_value         : (0)-(24);

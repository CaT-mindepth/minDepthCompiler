...
blackbox stateful_alu test_stateful_alu_0_0_blackbox {
    ...
    reg                       : reg_0;
    condition_lo              : (((0-ipv4.p_size_bytes0)+alu_hi)+1)<0;
    condition_hi              : (0-alu_lo)==0;
    update_lo_1_predicate     : (condition_hi) and (condition_lo);
    update_lo_1_value         : (ipv4.p_size_bytes0)-(0);
...
blackbox stateful_alu test_stateful_alu_1_3_blackbox {
    ...
    reg                       : reg_3;
    condition_lo              : (((0-ipv4.branch)-0)+1)<0;
    condition_hi              : ((0-ipv4.branch)-alu_hi)==0;
    update_lo_1_predicate     : false;
    update_lo_1_value         : (ipv4.branch)+(1);
    update_lo_2_predicate     :  not ((condition_hi) or (condition_lo));
    update_lo_2_value         : (ipv4.p_rtt0)+(alu_lo);
    update_hi_1_predicate     : false;
    update_hi_1_value         : (7)-(0);
    update_hi_2_predicate     : true;
    update_hi_2_value         : (11)-(23);
    output_predicate          : 1;
    output_value              : alu_lo;
